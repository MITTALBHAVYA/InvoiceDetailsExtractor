...
st.markdown("""
    **Welcome to the Invoice Extraction App!**  
    Upload your invoice file and choose the method of extraction. 
                ...
                if response:
                    try:
                        ...
                        if "Total Amount" in json_response:
                            st.markdown(f"**Total Amount:** {json_response['Total Amount']}")
